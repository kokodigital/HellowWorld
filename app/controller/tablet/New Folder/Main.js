...
Ext.define('Kitchensink.controller.tablet.Main', {
    ...
    onNavTap: function(nestedList, list, index) {
        var record = list.getStore().getAt(index);
			console.log('record:'+record.toUrl());
			console.log('source:'+record.get('source'));
			console.log('animation:'+record.get('animation'));
			console.log('limit:'+record.get('limit'));
			console.log('preventHide:'+record.get('source'));
			console.log('view:'+record.get('source'));
			
        if (record.isLeaf()) {
		console.log('leaf record:'+record.toUrl());
